...
namespace BooksApp.Data.Concrete.EfCore.Config
{
    public class BookConfig : IEntityTypeConfiguration<Book>
    {
        public void Configure(EntityTypeBuilder<Book> builder)
        {
            ...
            builder.HasData(
                new Book { Id = 1, CreatedDate = DateTime.Now, ModifiedDate = DateTime.Now, IsApproved = true, Name = "Benim Peygamber’im Çocukları Çok Severdi", Stock = 10, Price = 38, PageCount = 24, EditionYear = 2022, EditionNumber = 1, Url = "benim-peygamberim-cocuklari-cok-severdi" },
                new Book { Id = 2, CreatedDate = DateTime.Now, ModifiedDate = DateTime.Now, IsApproved = true, Name = "Kader Sarmalı", Stock = 10, Price = 92, PageCount = 384, EditionYear = 2023, EditionNumber = 1, Url = "kader-sarmali" },
